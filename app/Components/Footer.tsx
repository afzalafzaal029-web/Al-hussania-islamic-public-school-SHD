...
//   return (
//     <footer className="bg-[#fffffd] rounded-t-lg w-full cursor-default text-white pt-12 pb-6 sm:pt-16 sm:pb-8 border-t border-blue-900/40">
//       <div className="max-w-7xl mx-auto px-7 sm:px-6 lg:px-8 xl:max-w-[85rem] 3xl:max-w-[100rem]">
//         <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-9 gap-x-6 sm:gap-x-8 text-left mb-12">
...
//                 />
//               </div>
//               <span className="font-extrabold text-sm sm:text-base leading-snug text-[#7ab89f] tracking-wide uppercase">
//                 Al-Hussainia <br />
...
//               </span>
//             </div>
//             <p className="text-blue-900 text-xs sm:text-sm leading-relaxed max-w-sm font-medium">
...
//             <h3 className="text-[#7ab89f] font-black text-xs uppercase tracking-[0.15em] mb-4 sm:mb-5">
//               Quick Links
//             </h3>
//             <ul className="space-y-3 text-xs sm:text-sm text-blue-200/90 font-medium">
//               {[
...
//                   <Link
//                     href={href}
//                     className="flex items-center gap-2 hover:text-blue-900 hover:translate-x-1 transition-all duration-200 group"
//                   >
//                     <ChevronRight
//                       size={14}
//                       className="text-[#7ab89f] group-hover:text-blue-900 transition-colors flex-shrink-0"
//                     />
//                     {label}
//                   </Link>
//                 </li>
...
//                   <ChevronRight
//                     size={14}
//                     className="text-blue-900/70 flex-shrink-0 mt-0.5"
//                   />
//                   <span>{item}</span>
//                 </li>
//               ))}
...
//               Contact Info
//             </h3>
//             <ul className="space-y-3.5 text-xs sm:text-sm text-blue-200/90 font-medium w-full flex flex-col">
...
//                 <Phone size={15} className="text-blue-900 flex-shrink-0" />
//                 <a
//                   href="tel:03163758205"
...
//               </li>
//               <li className="flex items-center gap-3">
//                 <Mail size={15} className="text-blue-900 flex-shrink-0" />
//                 <a
...
//         {/* ── Bottom Bar ── */}
//         <div className="border-t border-blue-900/60 pt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 text-[11px] sm:text-xs font-semibold text-[#7ab89f] tracking-wide text-left">
//           <p className="leading-relaxed">
//             &copy; {new Date().getFullYear()} Al-Hussainia Islamic Public
//             School. <br className="sm:hidden" /> All rights reserved.
//           </p>
//           <div className="flex items-center gap-4">
//             <span className="hidden sm:inline">|</span>
//             <p className="text-blue-400/90">Shahdadpur, Sindh</p>
//           </div>
//         </div>
//       </div>
//     </footer>
...
// ── Brand tokens (derived from the school crest) ──────────────────────────
// ink        #0C3960  – crest navy, used for headings / strong text
// ink-soft   #4A6076  – softened navy for body copy (better reading comfort)
// emerald    #2F7D5C  – deep Islamic green, AA-safe on white, section labels
// sage       #7AB89F  – lighter green, decorative only (rings, tints)
// gold       #C9A227  – premium accent used sparingly: hairline, halo, icons
